...
public class MensClothingPageMANDM extends commonMethodsMANDM {
	...
	public static void checkItemPriceCartTotal() throws InterruptedException {
	...
	public static double AddItemPricesSumAgainstCartTotal() throws InterruptedException {
		refreshPage();
		hoverOverElement(By.cssSelector(".basket__icon"));
		Thread.sleep(2000);
		if(isElementNotPresent(By.xpath("(//*[@id='basketContent']//*[@class='mini-basket-item__price'])[1]")))
			hoverOverElement(By.cssSelector(".basket__icon"));
